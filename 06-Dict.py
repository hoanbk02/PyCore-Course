...
# List, Tuple, Set => Chuỗi các phần tử (có thứ tự xác định, hoặc ko xác định)
...
""" Làm thế nào để tạo ra một dict?
    ...
    còn key thì chỉ được dùng kiểu dữ liệu bất biến (immutable) (string, number hoặc tuple với các phần tử bất biến) và không lặp
"""
...
# print(my_dict['phone'])
# print(my_dict.get('phone', '0987654321'))

""" Thay đổi hoặc thêm mới phần tử:
    - dict là kiểu không bất biến => có thể thay đổi được
...
# print(my_dict)
#
# my_dict['phone'] = '0987654321'  # Thêm mới
# print(my_dict)
...
# my_dict = {}.fromkeys([1, 3, 5, 2], 'xk')
# # print(my_dict)
#
# # print("Test phương thức setdefault", my_dict.setdefault(1, 'x0'))
# # print(my_dict)
#
# my_dict.update({
#     1: 1000,
