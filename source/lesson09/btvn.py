...
Bài 09: Viết chương trình đếm số lần xuất hiện các từ đơn trong một đoạn văn bản
...
values_unique = set(dict_02.values())
print(f'Value không trùng lặp: {values_unique}')
