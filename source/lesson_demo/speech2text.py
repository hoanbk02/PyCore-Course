...
Bước Chuẩn bị
    ...
    Ubuntu: Nếu khi cài bị error về portaudio thì giải quyết bằng cài: sudo apt-get install portaudio19-dev python-pyaudio
    MacOS: https://programmerah.com/mac-pyaudio-installation-fatal-error-portaudio-h-file-not-found-33342/
"""
